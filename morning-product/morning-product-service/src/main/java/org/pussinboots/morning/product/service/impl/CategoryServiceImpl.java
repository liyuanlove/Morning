...
public class CategoryServiceImpl extends ServiceImpl<CategoryMapper, Category> implements ICategoryService {
	...
	@Override
	public List<Category> listUpperByProductId(String productNumber, Integer status) {

		ProductCategory queryProductCategory = new ProductCategory();
		queryProductCategory.setProductNumber(productNumber);
		...
		for (CategoryVO otherCategory : otherCategorys) {
			...
			if (!products.isEmpty()) {
				...
				for (ProductVO product : products) {
					ProductVO vo = productCategoryMapper.getComment(product.getProductNumber(), type,
