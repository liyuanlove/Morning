...
public class OrderProductServiceImpl extends ServiceImpl<OrderProductMapper, OrderProduct> implements IOrderProductService {
	...
	public List<OrderListBack> listAllOrder(Integer offset,Integer limit){
		return orderProductMapper.listAllOrder(offset, limit);
	}

	public Integer getAllOrderTotal(){
		return orderProductMapper.getAllOrderTotal();
	}
