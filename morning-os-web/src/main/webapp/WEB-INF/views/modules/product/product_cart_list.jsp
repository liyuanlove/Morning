        ...
        <tbody>
          <c:forEach items="${cartVO.shoppingCartVOs}" var="shoppingCart">
            <tr data-sid="${shoppingCart.productSpecNumber}">
              ...
              <td class="goods"><a href="${ctx}/detail/${shoppingCart.productNumber}" target="_blank"><img src="${imageServer}/${shoppingCart.picImg}" alt="${shoppingCart.name}"/></a> <a href="${ctx}/detail/${shoppingCart.productNumber}" target="_blank"><span>${shoppingCart.name}
