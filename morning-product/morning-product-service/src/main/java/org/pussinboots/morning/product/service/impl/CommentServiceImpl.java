...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements ICommentService {
	...
	@Override
	public BasePageDTO<CommentVO> listByProductId(String productNumber, Integer status, PageInfo pageInfo) {
		
		Page<CommentVO> page = new Page<>(pageInfo.getCurrent(), pageInfo.getLimit());
		List<CommentVO> commentVOs = commentMapper.listByProductId(productNumber, status, pageInfo, page);
