...
public interface UserMapper extends BaseMapper<User> {
	 ...
	 * @return
	 */
	List<OSUserVO> listUserByPager(@Param("offset") Integer offset, @Param("limit") Integer limit);
	 ...
	 * @return
	 */
	Integer frozenUser(@Param("userNumber") String userNumber,@Param("type") Integer type);
