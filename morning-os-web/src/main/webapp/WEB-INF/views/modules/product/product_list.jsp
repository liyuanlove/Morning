        ...
        <div class="goods-list clearfix">
          <c:forEach items="${products}" var="product">
            <div class="goods-item">
              <div class="figure figure-img"><a title="${product.introduce}" href="${ctx}/detail/${product.productNumber}"><img src="${imageServer}/${product.picImg}" title="${product.introduce}" width="200" height="200" alt="${product.name}" /></a></div>
              <p class="desc"></p>
              ...
              <div class="thumbs">
                <ul class="thumb-list clearfix">
                  <li data-gid="${product.productNumber}"><img src="${imageServer}${product.picImg}" width="34" height="34" title="${product.introduce}" alt="${product.name}" /></li>
                </ul>
