...
import org.pussinboots.morning.common.util.FastdfsUtil;
...
public class UploadManager {
	 ...
	 * FastDFS文件上传功能
	 */
	public static UploadResult uploadFastDFS(HttpServletRequest request, MultipartFile avatarFile, String dir, String belong){
		UploadResult uploadResult = null;
		try {
			String tempurl =  FastdfsUtil.fileUpload(avatarFile.getBytes());
			String[] saveUrl = tempurl.split("M00");
			uploadResult = new UploadResult(true,saveUrl[1]);
		}catch (Exception e){
			e.printStackTrace();
