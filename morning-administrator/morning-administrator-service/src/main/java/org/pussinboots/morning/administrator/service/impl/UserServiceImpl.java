...
import org.pussinboots.morning.administrator.pojo.vo.OSUserVO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
	 ...
	 */
	@Override
	public List<OSUserVO> listUserByPager(Integer offset, Integer limit) {
		return userMapper.listUserByPager(offset, limit);
	}
	 ...
	 */
	@Override
	public boolean frozenUser(String userNumber, Integer type) {
		if(userNumber == null || type == null){
			return false;
		}
		switch (type){
			case 1:
				if(userMapper.frozenUser(userNumber, type)==1){
					return true;
				};
				break;
