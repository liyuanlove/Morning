...
function question_help() {
	$.ajax({
		type : 'get',
		dataType : 'text',
		url : baselocation + '/question/askList?productNumber=' + productNumber + '&sort=1&page=1',
...
function question_new() {
	$.ajax({
		type : 'get',
		dataType : 'text',
		url : baselocation + '/question/askList?productNumber=' + productNumber + '&sort=0&page=1',
		success : function(result) {
			$("#J_goodsQuestionBlock").html(result);
		}
	})
...
function comment_sup() {
	$.ajax({
		type : 'get',
		dataType : 'text',
		url : baselocation + '/comment/supList?productNumber=' + productNumber + '&sort=1&page=1',
		success : function(result) {
...
function comment_time_line() {
	$.ajax({
		type : 'get',
		dataType : 'text',
		url : baselocation + '/comment/tileLineList?productNumber=' + productNumber + '&sort=0&page=1',
		success : function(result) {
