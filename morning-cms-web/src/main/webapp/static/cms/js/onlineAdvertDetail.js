...
function picImgFormatter(value, row,index) {
	return '<a href="' + imageServer + row.picImg + '" target="_blank" title="' + row.title + '">' + value + '</a>';
}
...
function viewImage(picImg) {
    ...
    layer.open({
        ...
        maxmin: true,
        title: '查看图片',
        content: '/product/common/imageView?picImg='+picImg
    });
}
