...
public class QuestionController extends BaseController {
	...
	public String askList(Model model, @RequestParam(value = "productId", required = true) String productNumber,
		...
		BasePageDTO<Question> basePageDTO = questionService.listByProductId(productNumber, StatusEnum.SHOW.getStatus(),
				pageInfo);
	...
	@GetMapping(value = "/asklist")
	public String asklist(Model model, @RequestParam(value = "productNumber", required = true) String productNumber,
		...
		if (product != null) {
			...
			PageInfo pageInfo = new PageInfo(page, limit, QuestionSortEnum.typeOf(sort).getSort(),
					QuestionSortEnum.typeOf(sort).getOrder());
			BasePageDTO<Question> basePageDTO = questionService.listByProductId(product.getProductNumber(),
