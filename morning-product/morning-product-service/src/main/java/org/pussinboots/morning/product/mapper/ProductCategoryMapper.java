...
public interface ProductCategoryMapper extends BaseMapper<ProductCategory> {
	 ...
	 * @return
	 */
	ProductVO getComment(@Param("productNumber") String productNumber, @Param("type") Integer type,
	 ...
	 * @return
	 */
	Integer insert(@Param("productNumber") String productNumber,
								  @Param("categoryID") Integer categoryID,@Param("userName") String userName);
