...
public class CommentController extends BaseController{
	...
	public String supComment(Model model, @RequestParam(value = "productNumber", required = true) String productNumber,
		...
		BasePageDTO<CommentVO> basePageDTO = commentService.listByProductId(productNumber, StatusEnum.SHOW.getStatus(),
				pageInfo);
	...
	public String tileLineList(Model model, @RequestParam(value = "productNumber", required = true) String productNumber,
	...
	public String list(Model model, @RequestParam(value = "productNumber", required = true) String productNumber,
		...
		if (product != null) {
			// 根据类目ID查找上级类目列表
			List<Category> upperCategories = categoryService.listUpperByProductId(product.getProductNumber(),
					StatusEnum.SHOW.getStatus());
			
			// 根据商品ID查找商品属性
			ProductAttribute productAttribute = productAttributeService.getByProductId(product.getProductNumber());
			...
			BasePageDTO<CommentVO> basePageDTO = commentService.listByProductId(product.getProductNumber(),
