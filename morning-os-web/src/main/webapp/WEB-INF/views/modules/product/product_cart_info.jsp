  ...
  <div class="container-fluid">
    <div class="buy-succ-box clearfix">
      <div class="goods-content" id="J_goodsBox">
        <div class="goods-img"> <a href="${ctx}/detail/${shoppingCartVO.productNumber}"><img src="${imageServer}${shoppingCartVO.picImg}" title="${shoppingCartVO.name}" width="110" height="110"> </a></div>
