...
public class ProductImageServiceImpl extends ServiceImpl<ProductImageMapper, ProductImage> implements IProductImageService {
	...
	@Override
	public List<ProductImage> listByProductId(String productNumber, Integer showNumber, Integer status) {
		return productImageMapper.listByProductId(productNumber, showNumber, status);
	}
