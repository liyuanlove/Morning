...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements IQuestionService {
	...
	@Override
	public BasePageDTO<Question>  listByProductId(String productNumber, Integer status, PageInfo pageInfo) {
		Page<Question> page = new Page<>(pageInfo.getCurrent(), pageInfo.getLimit());
		List<Question> questions = questionMapper.listByProductId(productNumber, status, pageInfo, page);
