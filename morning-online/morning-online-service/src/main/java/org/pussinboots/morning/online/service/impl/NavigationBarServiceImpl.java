...
import org.pussinboots.morning.common.support.other.Type;
import org.pussinboots.morning.common.support.page.PageInfo;
import org.pussinboots.morning.common.util.RedisCacheUtils;
...
public class NavigationBarServiceImpl extends ServiceImpl<NavigationBarMapper, NavigationBar> implements INavigationBarService {
	...
	public List<NavigationBar> listByNavigationId(Long navigationId) {
		...
		if (navigation != null) {
			return navigationBarMapper.listByNavigationId(navigationId, StatusEnum.SHOW.getStatus(),navigation.getShowNumber());
		}
		return null;
